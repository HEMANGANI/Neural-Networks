...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        out_pool, cache_p = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        out_relu, cache_r = affine_relu_forward(out_pool, W2, b2)
        scores, cache_a = affine_forward(out_relu, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dl3_dl2,dw3,db3 = affine_backward(grad,cache_a)
        dl2_dl1,dw2,db2 = affine_relu_backward(dl3_dl2,cache_r)
        dl1_dx,dw1,db1 = conv_relu_pool_backward(dl2_dl1, cache_p)
        grads['b1']=db1
        grads['b2']=db2
        grads['b3']=db3
