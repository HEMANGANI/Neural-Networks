...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    X_trainX_train = np.sum(self.X_train**2, axis=1)
    XX_train = np.dot(X, self.X_train.T)
    distances_squared = XX - 2 * XX_train + X_trainX_train.reshape(1, -1)
    dists = np.sqrt(distances_squared)
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
    return dists
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in range(num_test):
      ...
      closest_y = self.y_train[sorted_indices].tolist()
      #########################################################################
      # TODO:                                                                 #
